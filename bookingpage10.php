...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $res3=mysqli_query($conn,"SELECT  * from movies WHERE movie_serial='10'");
  while($row3=mysqli_fetch_array($res3))
    {
       $movie__name = $row3['movie_name'];
       $avl_seat = (int)$row3['movie_qty'];
       $cost = (int)$row3['movie_price'];
    };
...
mysqli_query($conn,$sql);
  $new_seat=$avl_seat-$movieseats;
  $sql1= "UPDATE movies SET movie_qty= '$new_seat' WHERE movie_serial= '10' ";
  mysqli_query($conn,$sql1);
    header("location:homepage_signed_in.php");
}
else
{
header("location:bookingpage10.php");
}
...
$res1=mysqli_query($conn,"SELECT  * from movies WHERE movie_serial='10'");
