...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $res3=mysqli_query($conn,"SELECT  * from movies WHERE movie_serial='8'");
...
mysqli_query($conn,$sql);
  ...
  $sql1= "UPDATE movies SET movie_qty= '$new_seat' WHERE movie_serial= '8' ";
  mysqli_query($conn,$sql1);
    header("location:homepage_signed_in.php");
}
else
{
header("location:bookingpage8.php");
}
...
$res1=mysqli_query($conn,"SELECT  * from movies WHERE movie_serial='8'");
