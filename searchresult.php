...
<div class="navbar">
  ...
  <a href="#">Thriller</a>
  <a href="#">Sci-Fi</a>
  <a href="userlogin.php" class="right">Sign in</a>
...
<div class="row">
  ...
  <div class="main">
      <table style="width: 20%; text-align: center;" border="0" cellpadding="7" >
<tbody>
<tr style="height: 350px;">
<td style="height: 350px;"><?php
  include "dbconfig.php";
  $res=mysqli_query($conn,"SELECT  * from movies WHERE movie_name='".$_POST['search']."'");
 while($row=mysqli_fetch_array($res))
{
?>
...
<td style="height: 21px;"><a href="bookingpage.php" target="_blank">Book Now</a> </td>
</tr>
