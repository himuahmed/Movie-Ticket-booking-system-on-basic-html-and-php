...
<div class="navbar">
  ...
  <a href="homepage_signed_in.php" class="right">User Signed in</a>
...
{
?>
<a href="bookingpage1.php" target="_blank">
...
<td style="height: 350px;"><?php
  include "dbconfig.php";
  $res=mysqli_query($conn,"SELECT  * from movies WHERE movie_catagory='Animation'");
 while($row=mysqli_fetch_array($res))
{
?>
