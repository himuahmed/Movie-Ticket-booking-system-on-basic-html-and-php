...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $res3=mysqli_query($conn,"SELECT  * from header_images WHERE sequence='5'");
...
mysqli_query($conn,$sql);
  ...
  $sql1= "UPDATE header_images SET movie_quan= '$new_seat' WHERE sequence= '5' ";
  mysqli_query($conn,$sql1);
    header("location:../homepage_signed_in.php");
}
else
{
header("location:bookingpage_h5.php");
}
...
$res1=mysqli_query($conn,"SELECT  * from header_images WHERE sequence='5'");
